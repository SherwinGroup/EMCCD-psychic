...
class Ui_HSG(object):
    def setupUi(self, HSG):
        ...
        HSG.setTabOrder(self.tCCDNIRwavelength, self.tCCDSeries)
        HSG.setTabOrder(self.tCCDSeries, self.tCCDFELP)
    ...
    def retranslateUi(self, HSG):
        ...
        self.groupBox_42.setTitle(_translate("HSG", "Series", None))
