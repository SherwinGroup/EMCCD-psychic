...
class Ui_Alignment(object):
    def setupUi(self, Alignment):
        ...
        self.bAddVertical = QtGui.QPushButton(self.tab_3)
        self.bAddVertical.setObjectName(_fromUtf8("bAddVertical"))
        self.gridLayout.addWidget(self.bAddVertical, 0, 0, 1, 1)
        self.bAddHoriz = QtGui.QPushButton(self.tab_3)
        self.bAddHoriz.setObjectName(_fromUtf8("bAddHoriz"))
