...
class ABSimage(EMCCDimage):
    '''
    This class is for handling absorption images to be able to spit out just
    the relevant 2x1600 spectrum.  It should be able to load both the blank
    spectrum and the sample spectrum, then divide them to give the absorption.
    '''
    
    def __init__(self, fname):
        '''
        This will initialize an absorption image instance.  The header will
